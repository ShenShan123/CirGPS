...
def downstream_tasks(loggers, loaders, g_model):
    start_epoch = 0
...
def train_regression_epoch(
        logger, loader, g_model, 
        reg_model, optimizer, scheduler,
        batch_accumulation):
    pass

def eval_regression_epoch(
        logger, loader, g_model, reg_model, split='val'):
    pass
"""
...
if __name__ == '__main__':
    ...
    # downstream_tasks(model, loaders)
